...
class PurchaseRequestLineMakePurchaseOrder(models.TransientModel):
    ...
    def _check_valid_request_line(self, request_line_ids):
        ...
        for line in self.env["purchase.request.line"].browse(request_line_ids):
            ...
            if line.request_id.state != "procurement":
                raise UserError(
    ...
    @api.model
    def _prepare_purchase_order(self, picking_type, group_id, company, origin, project_code, location_id):
    ...
    def make_purchase_order(self):
        ...
        for item in self.item_ids:
            ...
            if not purchase:
                ...
                if len(po_so_trading == 0):
                    raise ValidationError("SO Gak ada")
                else:
                    po_so_trading.write({"po_id": purchase.id})
