...
class PurchaseOrder(models.Model):
    ...
    prepared = fields.Many2one('hr.employee', string='Prepared By')
    verified = fields.Many2one('hr.employee', string='Verified By')
    ...
    def rfq_selected(self):
        ...
        if self.requisition_id:
            if self.requisition_id.order_count < 3 and not self.requisition_id.is_direksi_approved:
