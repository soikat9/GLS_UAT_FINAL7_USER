...
class SaleOrder(models.Model):
    ...
    director = fields.Many2one('hr.employee', string='Best Regards')
    ...
    approved = fields.Many2one('hr.employee', string='Received')
    received = fields.Many2one('hr.employee', string='Received')
