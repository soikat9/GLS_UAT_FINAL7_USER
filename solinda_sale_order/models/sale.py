...
class SaleOrder(models.Model):
    ...
    directorx = fields.Many2one('res.users', string='Best Regards')
    ...
    approvedx = fields.Many2one('res.users', string='Received')
    receivedx = fields.Many2one('res.users', string='Received')
